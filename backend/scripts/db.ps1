...
"@
  ...
  "schema" {
    ...
    foreach ($f in @("001_init.sql","002_powersync.sql","003_seed.sql","004_avoirs.sql","005_catalogues.sql","006_transferts.sql","007_inventaires.sql","008_pins.sql","009_verrou.sql","010_qr.sql","011_phase3.sql")) {
